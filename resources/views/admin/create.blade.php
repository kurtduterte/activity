...
<body class="gradient-bg min-h-screen">
    ...
    <div class="relative z-10 max-w-2xl mx-auto py-12 px-6">
        ...
        <form action="{{ route('admin.store') }}" enctype="multipart/form-data" method="POST"
            class="glass-effect rounded-3xl shadow-2xl overflow-hidden animate-slide-up stagger-2">
            @csrf
            <div class="p-8 space-y-8">
                ...
                <div class="form-group relative animate-slide-up stagger-3">
                    <input type="text" name="title" id="title" placeholder=" "
                        class="w-full bg-transparent border-0 border-b-2 border-gray-200 px-0 py-4 text-lg font-medium text-gray-800 placeholder-transparent focus:border-purple-500 focus:ring-0 input-focus"
                        required>
                    <label for="title"
                        class="floating-label absolute left-0 top-4 text-gray-500 font-medium pointer-events-none">
                        Event Title
                    </label>
                    <div
                        class="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 transform scale-x-0 transition-transform duration-300 origin-left focus-within:scale-x-100">
                    </div>
                </div>
                ...
                <div class="form-group relative animate-slide-up stagger-4">
                    <textarea name="description" id="description" placeholder=" " rows="4"
                        class="w-full bg-transparent border-0 border-b-2 border-gray-200 px-0 py-4 text-lg text-gray-800 placeholder-transparent focus:border-purple-500 focus:ring-0 resize-none input-focus"
                        required></textarea>
            ...
            <div class="bg-gray-50 px-8 py-6 flex justify-between items-center animate-slide-up stagger-6">
                <a href="/events"
                    class="group inline-flex items-center px-6 py-3 text-gray-600 font-semibold rounded-xl hover:bg-white transition-all duration-300 btn-hover">
                ...
                <button type="submit"
                    class="group inline-flex items-center px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 btn-hover">
