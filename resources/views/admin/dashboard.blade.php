...
<body class="gradient-bg min-h-screen">
    ...
    @if (session('success'))
        <div
            class="fixed top-6 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-6 py-3 rounded-full shadow-lg z-50 animate-fade-in">
            {{ session('success') }}
        </div>
    @endif
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="flex items-center mb-4">
                        <div
                            class="inline-flex items-center justify-center w-16 h-16 bg-white bg-opacity-20 rounded-2xl mr-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('admin.archived') }}"
                        class="group inline-flex items-center px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 btn-hover animate-slide-up stagger-1">
                    ...
                    <a href="{{ route('admin.create') }}"
                        class="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 btn-hover animate-slide-up stagger-1">
                        <svg class="w-6 h-6 mr-3 group-hover:rotate-90 transition-transform duration-300" fill="none"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            <th
                                class="py-6 px-8 text-left text-sm font-bold text-gray-700 uppercase tracking-wider border-b border-gray-200">
                            ...
                            <th
                                ...
                                <div class="flex items-center">
                                    <svg class="w-4 h-4 mr-2 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M5.05 4.05a7 7 0 119.9 9.9L5.05 4.05zM10 18a8 8 0 100-16 8 8 0 000 16z"
                                            clip-rule="evenodd"></path>
                                    </svg>
                                    Location
                                </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($events as $event)
                            <tr class="table-row-hover group">
                                <td class="py-6 px-8">
                                    <div
                                        class="font-semibold text-gray-900 text-lg group-hover:text-purple-600 transition-colors duration-200">
                                        {{ $event->title }}
                                    </div>
                                </td>
                                <td class="py-6 px-8">
                                ...
                                <td class="py-6 px-8">
                                    <div class="flex items-center text-gray-700">
                                        <svg class="w-4 h-4 mr-2 text-red-400" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                                                d="M5.05 4.05a7 7 0 119.9 9.9L5.05 4.05zM10 18a8 8 0 100-16 8 8 0 000 16z"
                                                clip-rule="evenodd"></path>
                                ...
                                <td class="py-6 px-8">
                                    <div class="flex items-center">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $isUpcoming ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                ...
                                <td colspan="5" class="py-20 text-center">
                                    <div class="empty-state rounded-2xl mx-8 p-12">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 text-lg mb-8 max-w-md">Get started by creating your
                                                first event. It's easy and takes just a few minutes!</p>
                                            <a href="{{ route('admin.create') }}"
                                                class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 btn-hover">
