...
<body class="bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 min-h-screen">
    ...
    <div class="relative overflow-hidden py-12">
        <div class="max-w-6xl mx-auto px-6">
            <div class="animate-fade-in-up">
                ...
                <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-800 bg-clip-text text-transparent mb-4">
                    Edit Event Details
                </h1>
        ...
        <div class="absolute top-0 right-1/4 transform translate-x-1/2 -translate-y-1/2">
            <div class="w-64 h-64 admin-gradient rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse-slow"></div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto py-8 px-6">
        ...
        <div class="glass-effect rounded-3xl shadow-2xl border border-white/20 overflow-hidden animate-fade-in-up">
            ...
            <!-- Form Content -->
            <form action="{{ route('admin.update', $event->id) }}" method="POST" class="p-8 space-y-8">
                @csrf
                @method('PUT')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createChangeIndicator() {
                ...
                indicator.className = 'fixed bottom-6 right-6 bg-amber-500 text-white px-4 py-2 rounded-lg shadow-lg animate-bounce hidden z-50';
                indicator.innerHTML = `
            ...
            function showNotification(message, type = 'info') {
                ...
                notification.className = `fixed top-6 right-6 ${bgColor} text-white px-6 py-3 rounded-lg shadow-lg animate-slide-down z-50`;
